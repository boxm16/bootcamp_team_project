...
$(".btn-pref .btn").click(function () {
    ...
    <div class="col-lg-12 col-sm-12">
        ...
        <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="well">
            ...
            <div class="btn-group" role="group">
                <a href="http://localhost:8080/seek_play/event.htm" data-toggle="tab"><button type="button" id="following" class="btn btn-primary"  data-toggle="tab"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
        ...
        <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="well">    
            <div class="btn-group" role="group">
               <a href="http://localhost:8080/seek_play/.htm" data-toggle="tab"><button type="button" id="create" class="btn btn-default" ><span class="glyphicon glyphicon-file" aria-hidden="true"></span>
                    <div class="hidden-xs">Create</div>
                    </button></a>
            </div>
            <div class="btn-group" role="group">
                <a href="http://localhost:8080/seek_play/.htm" data-toggle="tab"><button type="button" id="edit" class="btn btn-default" data-toggle="tab"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                    <div class="hidden-xs">Edit</div>
                    </button></a>
            </div>
            <div class="btn-group" role="group">
                <a href="http://localhost:8080/seek_play/.htm" data-toggle="tab"><button type="button" id="delete" class="btn btn-default" data-toggle="tab"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>

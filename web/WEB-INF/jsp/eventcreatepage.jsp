    ...
    <body>
        ...
        <div class="col-lg-12 col-sm-12">
            ...
            <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="well">
                ...
                <div class="btn-group" role="group">
                    <a href="http://localhost:8080/seek_play/messenger3.htm" data-toggle="tab"><button type="button" id="stars" class="btn btn-default" > <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
        ...
        <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="well">
            ...
            <div class="btn-group" role="group">
                <a href="http://localhost:8080/seek_play/booking_manage.htm" data-toggle="tab"><button type="button" id="event" class="btn btn-primary"  data-toggle="tab"><h4><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></h4>
        ...
        <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="well">    
            <div class="btn-group" role="group">
                <a href="http://localhost:8080/seek_play/eventcreate.htm" data-toggle="tab"><button type="button" id="create" class="btn btn-primary" ><h4><span class="glyphicon glyphicon-file" aria-hidden="true"></span></h4>
